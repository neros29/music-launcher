...
@pytest.mark.parametrize("tokens, expected", [
    ...
    (gen_tokens("playlists: (ironmouse)"), [("", token_types.SOF), ("playlists:", token_types.TYPE), (' (ironmouse', token_types.VALUE), (")", token_types.R_OP), ("", token_types.EOF)]),
    (gen_tokens("(ironmouse title: left right)"), [("", token_types.SOF), (" artist:", token_types.TYPE), ('(ironmouse', token_types.VALUE), (" and ", token_types.OP), (" title:", token_types.TYPE), (" left right", token_types.VALUE), (")", token_types.R_OP), ("", token_types.EOF)])
    ])
...
@pytest.mark.parametrize("tokens, expected", [
    ...
    (gen_tokens("albums: (artist: ironmouse)"), [("playlists", "scope", [("artist", "fuzz", "ironmouse")])])
    ])
